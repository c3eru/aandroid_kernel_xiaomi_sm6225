...
#endif
#if defined(CONFIG_KERNEL_DRIVER_D2S_CN)
static struct class_attribute ant_div_state =
		__ATTR(ant_div_state, S_IRUGO, ant_div_state_show, ant_div_state_store);
#else
static struct class_attribute ant_div_state =
		__ATTR(ant_div_state, S_IRUGO, ant_div_state_show, NULL);
#endif
